...
const products = [
    ...
    },
    {
        ...
        price: 1799,
        category: "Smartwatch",
        imageUrl: "uploads/products/watch-prod-3.webp",
        color: "silver",
        index: 6
    },
    {
        name: "boAt Iris | Round Dial Smart Watch with 1.39 AMOLED Display, Multiple Watch Faces",
        ...
        price: 4499,
        category: "Smartwatch",
        imageUrl: "uploads/products/watch-prod-2.webp",
        color: "red",
        index: 7
    },
    {
        ...
        price: 1799,
        category: "Smartwatch",
        imageUrl: "uploads/products/watch-prod-1.webp",
        color: "black",
        index: 8
    },
    {
        ...
        price: 3999,
        category: "Speaker",
        imageUrl: "uploads/products/speaker-prod-3.webp",
        color: "black",
        index: 9
    },
    {
        ...
        price: 1699,
        category: "Speaker",
        imageUrl: "uploads/products/speaker-prod-1.webp",
        color: "black",
        index: 10
    },
    {
        name: "Stone 1000v2",
        description: "Powerful and Precise. Stone 1000v2 is the premier wireless speaker that provides the best audio in the business. With its 14W stereo sound, get a boogie on and party all night. Stone 1000v2 also comes packed with state-of-the-art specs to keep you engrossed and engaged through it all!.",
        price: 2999,
        category: "Speaker",
        imageUrl: "uploads/products/speaker-prod-2.webp",
        color: "red",
        index: 11
    },
    {
        name: "boAt Stone 500 - Portable Bluetooth Speaker",
        description: "Become the life of every party with Stone 500. Experience 10W RMS stereo sound and groove with your gang on your favourite tunes. Double the thump with its TWS functionality that lets you connect & play 2 Stone 500 together. The dynamic RGB lights will add to the vibe of your party as you get transported to a club setting. Its universal connectivity with multiple connectivity modes —Bluetooth v5.0, AUX, USB and FM mode. With a Type-C charging interface & instant voice assistant, this wireless speaker will make your life easier as you enjoy the sound of your choice. With Stone 500, it is time to #BeTheLimelight.",
        price: 1999,
        category: "Speaker",
        imageUrl: "uploads/products/speaker-prod-5.webp",
        color: "black",
        index: 12
    },
    {
        name: "boAt Party Pal 50 - Bluetooth Speaker",
        description: "Immerse in the 20W RMS Stereo Sound with the powerful Party Pal 50 bluetooth speaker. Set the vibes of the party just right with the RGB LEDs. Keep worries at bay and party poolside with IPX5 splash resistant! Get, set, grooving as Party Pal 50 comes with a powerful playback of 4.5 Hrs. Access Instant Voice Assistant and enjoy the multiple connectivity modes- USB, AUX, Bluetooth v5.1, and FM. Coming with Type-C interface, Party Pal 50 is all you need to set the mood just about right. So, where y’all partying at?",
        price: 3799,
        category: "Speaker",
        imageUrl: "uploads/products/speaker-prod-4.webp",
        color: "black",
        index: 13
    },
    {
        ...
        price: 1499,
        category: "Earbuds",
        imageUrl: "uploads/products/earbuds-prod-1.webp",
        color: "white",
        index: 14
    },
    {
        ...
        price: 1399,
        category: "Earbuds",
        imageUrl: "uploads/products/earbuds-prod-2.webp",
        color: "blue",
        index: 15
    },
    {
        ...
        price: 1499,
        category: "Earbuds",
        imageUrl: "uploads/products/earbuds-prod-3.webp",
        color: "black",
        index: 15
    },
    {
        ...
        price: 2499,
        category: "Earbuds",
        imageUrl: "uploads/products/earbuds-prod-4.webp",
        color: "yellow",
        index: 16
    },
    {
        name: "boAt TRebel Airdopes 402 | In-Ear Earbuds With 10mm Driver, IPX4 Sweat0",
        ...
        price: 1999,
        category: "Earbuds",
        imageUrl: "uploads/products/earbuds-prod-5.webp",
        color: "grey",
        index: 17
    }
];
